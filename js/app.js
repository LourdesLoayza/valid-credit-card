...
// Se declara la funci�n para validar la numeraci�n de la tarjeta
...
Los valores que eran de tipo string se cambian a tipo numero*/
  ...
  var sumPar = parArray.reduce(function(a, b) {
    return a + b; 
  });
...
Los valores que eran de tipo string se cambian a tipo numero, cada valor es multiplicado *2 antes de ser ingresado en el array*/
  ...
  /* Se hace una validaci�n antes de sumar los elementos del array de posiciones impares si estos resultados son mayor o igual a 10
...
con el resto de valores del array que son menores a 10*/
  ...
  for (h = 0;h <= impArray.length - 1;h++) {
    ...
    /* Tanto los valors de la suma impar como par se suman y a este total se le aplica la validac�on. Si el resultado del mod es 0 los
